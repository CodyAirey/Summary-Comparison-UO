    ...
    for sentence_list in summaries:
        ...
        for i, token in enumerate(ref_doc):
            ...
            for j, sentence in enumerate(sentence_list):
                ...
                current_score = evaluator.score([token], [sentence])['scores'][0]
...
process_summaries(human_sums_bad)
process_summaries(human_sums_good)
process_summaries(human_sums_exact)